// NiosAttempt_mm_interconnect_0.v
...
`timescale 1 ps / 1 ps
module NiosAttempt_mm_interconnect_0 (
	...
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [93:0] onchip_memory_s1_agent_rf_source_data;                                     // onchip_memory_s1_agent:rf_source_data -> onchip_memory_s1_agent_rsp_fifo:in_data
	...
	wire  [93:0] onchip_memory_s1_agent_rsp_fifo_out_data;                                  // onchip_memory_s1_agent_rsp_fifo:out_data -> onchip_memory_s1_agent:rf_sink_data
	...
	wire  [92:0] cmd_mux_002_src_data;                                                      // cmd_mux_002:src_data -> onchip_memory_s1_agent:cp_data
	...
	wire  [18:0] sys_timer_s1_agent_m0_address;                                             // sys_timer_s1_agent:m0_address -> sys_timer_s1_translator:uav_address
	...
	wire  [92:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> sys_timer_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // sys_timer_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> sys_timer_s1_agent:cp_channel
	...
	wire  [92:0] onchip_memory_s1_agent_rp_data;                                            // onchip_memory_s1_agent:rp_data -> router_004:sink_data
	...
	wire  [92:0] sys_timer_s1_agent_rp_data;                                                // sys_timer_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [92:0] router_src_data;                                                           // router:src_data -> cpu_data_master_limiter:cmd_sink_data
	...
	wire  [92:0] cpu_data_master_limiter_cmd_src_data;                                      // cpu_data_master_limiter:cmd_src_data -> cmd_demux:sink_data
	...
	wire  [92:0] rsp_mux_src_data;                                                          // rsp_mux:src_data -> cpu_data_master_limiter:rsp_sink_data
	...
	wire  [92:0] cpu_data_master_limiter_rsp_src_data;                                      // cpu_data_master_limiter:rsp_src_data -> cpu_data_master_agent:rp_data
	...
	NiosAttempt_mm_interconnect_0_router router (
	...
	NiosAttempt_mm_interconnect_0_router_001 router_001 (
	...
	NiosAttempt_mm_interconnect_0_router_002 router_002 (
	...
	NiosAttempt_mm_interconnect_0_router_003 router_003 (
	...
	NiosAttempt_mm_interconnect_0_router_003 router_004 (
	...
	NiosAttempt_mm_interconnect_0_router_002 router_005 (
	...
	NiosAttempt_mm_interconnect_0_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                   //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),         //  clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_cmd_demux_001 cmd_demux_001 (
		.clk                (clk_clk_clk),                                          //        clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset),                //  clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_cmd_mux_001 cmd_mux_002 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_cmd_mux cmd_mux_003 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_demux rsp_demux (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_demux_001 rsp_demux_002 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_demux rsp_demux_003 (
		.clk                (clk_clk_clk),                           //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_rsp_mux_001 rsp_mux_001 (
		.clk                 (clk_clk_clk),                           //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	NiosAttempt_mm_interconnect_0_avalon_st_adapter #(
		.inBitsPerSymbol (34),
		.inUsePackets    (0),
		.inDataWidth     (34),
		.inChannelWidth  (0),
